    ...
    <div>
      ...
      <section className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid lg:grid-cols-[2fr_1fr] gap-8 md:gap-12 max-w-6xl mx-auto">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6 font-[family-name:var(--font-playfair)]">
              Envíanos un mensaje
            </h2>
      ...
      {/* ========== MVP: STORE LOCATOR SECTION HIDDEN - RESTORE WHEN STORES ARE AVAILABLE ========== */}
      {/* 
      <section className="container mx-auto px-4 pb-12 md:pb-16">
        <div className="text-center mb-6">
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">¿Querés comprarlo en persona?</h2>
          <p className="text-sm md:text-base text-muted-foreground">Buscá tu tienda más cercana</p>
        </div>
