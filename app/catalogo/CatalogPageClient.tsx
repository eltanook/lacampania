    ...
    <div>
      <section className="relative h-[300px] md:h-[400px] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image src="/catalog-banner.jpg" alt="Catálogo de Productos" fill className="object-cover" />
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-lg md:text-xl text-white/90">Descubre todos nuestros productos</p>
        </div>
      </section>
