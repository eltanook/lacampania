...
export const products: Product[] = [
  {
    ...
    images: [
      ...
      "/board-game-components-spread.jpg",
      "/board-game-cards-detail.jpg",
      "/board-game-gameplay-action.jpg",
    ],
  ...
  },
  {
    ...
    stock: "normal",
    category: "Accesorios",
    images: ["/card-game-sleeves-protectors.jpg", "/card-sleeves-packaging-premium-quality.jpg"],
